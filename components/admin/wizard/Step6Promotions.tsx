  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-400">Configure promotional codes</p>
      </div>
            ...
            promotions.map((promo) => (
              <div key={promo.id} className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                ...
                <span className={`px-3 py-1 rounded-full text-xs ${
                  promo.active !== false ? 'bg-green-500/20 text-green-400' : 'bg-gray-500/20 text-gray-400'
                }`}>
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full px-4 py-2 bg-purple-600 rounded-lg hover:bg-purple-700 disabled:bg-gray-600"
        >
          Add Code
        </button>
        ...
        <div className="space-y-2">
          {eventPromotions.map((promo) => (
            <div key={promo.id} className="flex justify-between items-center p-3 bg-white/5 rounded-lg">
              <div>
