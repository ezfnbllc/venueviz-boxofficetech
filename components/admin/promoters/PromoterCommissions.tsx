...
interface PromoterCommissionsProps {
  promoterId: string
}

export default function PromoterCommissions({ promoterId }: PromoterCommissionsProps) {
  ...
  const loadCommissions = async () => {
    try {
      const data = await PromoterService.getCommissions(promoterId)
      setCommissions(data)
    } catch (error) {
