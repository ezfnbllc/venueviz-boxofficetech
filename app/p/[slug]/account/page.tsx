        ...
        <div className="container mx-auto px-4 py-4">
          <nav aria-label="breadcrumb">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li className="text-gray-900 dark:text-white font-medium">My Account</li>
            </ol>
          </nav>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-2">
                    {user.emailVerified ? (
                      ...
                      <>
                        ...
                        <span className="text-yellow-600 dark:text-yellow-400 text-sm">Email not verified</span>
                      </>
                    )}
                  </div>
                </div>
              ...
              <div>
                {loading ? (
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-12 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-6">You haven&apos;t purchased any tickets yet.</p>
                    <Link
                      href={`/p/${slug}/events`}
                  ...
                  <div className="space-y-4">
                    {orders.map((order) => (
                      <Link
                        ...
                        className="block bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:border-[#6ac045] transition-colors"
                      >
