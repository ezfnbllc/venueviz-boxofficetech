        ...
        <div className="container mx-auto px-4 py-4">
          <nav aria-label="breadcrumb">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li className="text-gray-900 font-medium">Booking Confirmed</li>
            </ol>
          </nav>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
              {/* Success Header */}
              <div className="text-center p-8 bg-gradient-to-b from-green-50 to-white">
                ...
                {/* Add to Calendar */}
                <div className="mt-6">
                  <span className="text-sm text-gray-500 block mb-3">Add to Calendar</span>
              ...
              <div className="p-6 border-t border-gray-100">
                ...
                {primaryEvent && (
                  <div className="flex gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      <h2 className="font-semibold text-gray-900 mb-1">{primaryEvent.eventName}</h2>
                      <span className="text-sm text-gray-600 block mb-2">{formattedDate}</span>
                ...
                <Link
                  ...
                  className="main-btn btn-hover h-12 w-full flex items-center justify-center gap-2"
                >
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href={`/p/${slug}/events`}
                className="text-center px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors"
              >
                Browse More Events
              </Link>
              <Link
