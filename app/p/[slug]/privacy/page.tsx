/**
 * Privacy Policy Page (CMS-Driven)
 *
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const cmsPage = await getCMSPage(promoter.id, 'privacy')

  return {
    title: cmsPage?.seo?.title || `Privacy Policy | ${promoter.name}`,
    description: cmsPage?.seo?.description || `Privacy policy for ${promoter.name}`,
