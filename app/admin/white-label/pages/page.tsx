      ...
      <div className="space-y-6">
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-8 text-center">
          ...
          <p className="text-slate-600 dark:text-gray-400 mb-4">
            Please select a specific tenant from the dropdown at the top of the page to manage their pages.
            <br />
            Pages are tenant-specific and cannot be viewed across all tenants.
          </p>
        </div>
      </div>
    )
