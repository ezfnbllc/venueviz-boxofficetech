...
const a=!getApps().length?initializeApp(c):getApps()[0];

export const db=getFirestore(a);
export const auth=getAuth(a);
export const storage=getStorage(a);
export const dbStatus={connected:true,name:'Firebase'};
